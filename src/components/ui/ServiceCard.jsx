import { noticeOrderCircularMenu } from "@/utils/noticeOrderCircularMenu";
...
const ServiceCard = () => {
  return (
    <div className="rounded-md shadow-[rgba(0,_0,_0,_0.24)_0px_3px_8px] hover:shadow-[rgba(0,_0,_0,_0.24)_0px_6px_12px] transition-shadow duration-300 ">
      ...
      >
        <h1 className="text-2xl mt-7 text-white">বিজ্ঞপ্তি/আদেশ/পরিপত্র</h1>

        <div className="size-24 ring ring-violet-700 bg-violet-700/50 rounded-full absolute -bottom-10  overflow-hidden flex justify-center items-center">
          <Image
            src="/images/FinalLogoSDG.png"
            alt="flag"
            width={96}
            height={96}
          />
      ...
      <div className="p-6 mt-5">
        {noticeOrderCircularMenu.map((menu, index) => (
