...
const AboutCard = ({ img, title }) => {
  return (
    <div className="flex gap-6 justify-center items-center shadow-[rgba(0,_0,_0,_0.24)_0px_3px_8px] p-4 rounded-md  bg-white transition-shadow duration-300 hover:shadow-[rgba(0,0,0,0.35)_0px_5px_15px] md:w-1/2  ">
      <div>
