...
const AboutUs = () => {
  return (
    <div className="container mx-auto px-1 my-10 shadow-[0px_2px_3px_-1px_rgba(0,0,0,0.1),0px_1px_0px_0px_rgba(25,28,33,0.02),0px_0px_0px_1px_rgba(25,28,33,0.08)] p-4 rounded-md bg-gradient-to-tr from-gray-200/40 to-gray-50/40">
      ...
      <div className="flex justify-between items-center gap-8 mt-6 mb-4">
